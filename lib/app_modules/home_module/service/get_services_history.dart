...
Future<List<BookingHistoryModel>> getServicesHistory() async {
  try {
    ...
    final url = Uri.parse(AppUrls.getServicesHistoryUrl).replace(
    ...
    if (resp.statusCode == 200) {
      ...
      final response =
          decoded.map((item) => BookingHistoryModel.fromJson(item)).toList();
      return response;
    } else {
