...
Future<ServicesBookingModel> getBookedServices() async {
  try {
    ...
    final url = Uri.parse(AppUrls.getBookingsUrl).replace(
    ...
    if (resp.statusCode == 200) {
      final response = ServicesBookingModel.fromJson(decoded);
      return response;
    } else {
