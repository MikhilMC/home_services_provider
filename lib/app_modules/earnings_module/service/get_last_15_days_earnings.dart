...
Future<List<EarningModel>> getLast15DaysEarnings() async {
  try {
    ...
    final url = Uri.parse(AppUrls.getLast15DaysEarningsUrl).replace(
    ...
    if (resp.statusCode == 200) {
      ...
      final response =
          decoded.map((item) => EarningModel.fromJson(item)).toList();
      return response;
    } else {
